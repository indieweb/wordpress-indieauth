...
echo '</strong>';
echo '<p>';
_e( 'The authorization header was not returned on this test, which means that your server may be stripping the Authorization header. If you are on Apache, try adding this line to your .htaccess file:', 'indieauth' );
echo '</p>';
