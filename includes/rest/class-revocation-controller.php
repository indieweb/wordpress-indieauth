<?php
/**
 * Revocation Controller class file.
 *
 * @package IndieAuth
 */
...
/**
 * Revocation Controller Functionality.
 *
 * @since 1.0.0
 */
class Revocation_Controller extends \WP_REST_Controller {
	 ...
	 * @var string
	 */
	protected $rest_base = 'revocation';
